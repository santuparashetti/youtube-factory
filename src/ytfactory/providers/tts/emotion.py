...
class EmotionProfile:
    ...
    pre_pause_ms: int   # silence injected before the scene (ms)
    post_pause_ms: int  # silence injected after each sentence (ms)
...
_PROFILES: dict[Emotion, EmotionProfile] = {
    ...
    Emotion.DETERMINATION: EmotionProfile(Emotion.DETERMINATION, "-3%",  "+0Hz", 200, 300),
...
_LEXICONS: dict[Emotion, list[str]] = {
    Emotion.CURIOSITY: [
        "what if", "how does", "why do", "why is", "could it be",
        "have you ever", "imagine", "consider", "wonder", "ask yourself",
        "question", "curious", "explore", "discover", "perhaps", "what would",
        "what does", "how many", "what kind",
    ],
    Emotion.WONDER: [
        "extraordinary", "incredible", "remarkable", "astonishing", "breathtaking",
        "universe", "vast", "infinite", "cosmic", "magnificent", "beautiful",
        "miracle", "transcendent", "profound", "beyond", "stunning",
        "incomprehensible", "unimaginable",
    ],
    Emotion.REFLECTION: [
        "perhaps", "maybe", "in truth", "beneath", "underneath", "deeper",
        "realize", "understand", "consider", "reflect", "remember", "look back",
        "truth is", "in fact", "we often", "most of us", "all of us",
        "think about it", "stop and",
    ],
    Emotion.MYSTERY: [
        "hidden", "secret", "beneath the surface", "unknown", "invisible",
        "shadow", "unseen", "lurking", "concealed", "buried", "unspoken",
        "silent force", "unseen hand", "mystery", "enigma", "behind",
        "operating", "controlling", "pulling", "without knowing",
    ],
    Emotion.PEACE: [
        "quiet", "still", "calm", "breathe", "gentle", "silence", "rest",
        "peace", "serene", "tranquil", "soft", "tender", "warm", "safe",
        "present", "simply", "enough", "slow down", "let go",
    ],
    Emotion.HOPE: [
        "yet", "still", "tomorrow", "possible", "possibility", "begin",
        "new", "light", "forward", "free", "choose", "different", "better",
        "change", "grow", "heal", "rise", "reclaim", "start", "step",
        "moment", "can", "will", "ready",
    ],
    Emotion.COMPASSION: [
        "you are not alone", "understand", "feel", "pain", "struggle",
        "heart", "reach out", "together", "kindness", "empathy", "grief",
        "carry", "burden", "human", "forgive", "accept", "love",
        "vulnerable", "honest", "real",
    ],
    Emotion.URGENCY: [
        "now", "must", "stop", "wake up", "immediately", "no longer",
        "time to", "cannot wait", "urgent", "act", "before it", "too late",
        "breaking point", "right now", "demand", "require", "every day",
        "every moment",
    ],
    Emotion.SADNESS: [
        "lost", "grief", "alone", "burden", "weight", "hollow", "empty",
        "absence", "gone", "miss", "mourn", "sorrow", "ache",
        "tears", "heartbreak", "loneliness", "faded", "left behind",
        "abandoned", "forgotten",
    ],
    Emotion.AWE: [
        "behold", "witness", "ancient", "thousands of years", "centuries",
        "look", "see", "observe", "watch", "stands", "endures", "survived",
        "timeless", "eternal", "history", "civilization", "legacy",
        "monument", "scale",
    ],
    Emotion.DETERMINATION: [
        "despite", "but still", "yet still", "keep", "persevere",
        "refuse", "stand", "rise", "fight", "overcome", "through it",
        "no matter", "will not", "regardless", "push", "resist",
        "hold on", "keep going",
    ],
    Emotion.REVELATION: [
        "this is", "the truth is", "here is", "what that means",
        "and that", "so here", "the answer", "simply this",
        "one thing", "everything changes", "changes everything",
        "that is why", "which means", "and so", "in other words",
    ],
}
